...
export default function ReAreaChartMultiple() {
  ...
  console.log("[Ironsight] Chart Dataset 1:", datasets[1].data);
    ...
    <div style={{ width: '100%', height: 500 }}>
      <ResponsiveContainer>
        ...
        >
          ...
          <Area type="monotone" dataKey="value1" stroke="#8142FF" fillOpacity={1} fill="url(#colorValue1)" />
          <Area type="monotone" dataKey="value2" stroke="#359EE5" fillOpacity={1} fill="url(#colorValue2)" />
